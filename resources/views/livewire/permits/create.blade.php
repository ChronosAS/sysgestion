            ...
            <div class="bg-slate-200 overflow-hidden shadow-xl sm:rounded-lg">
                <form class="mt-5  mx-10 container-md  text-center  flex items-center justify-center flex-wrap">
                    ...
                    <div class="mt-5 w-full px-3 sm:w-1/6">
                        <x-label for="dop" value="F. de Elaboración  del permiso" class="text-black" />
                    ...
                    <div class="mt-5 w-full px-3 sm:w-1/6">
                        <x-label for="doe" value="F. de Vencimiento del permiso" class="text-black" />
                    ...
                    {{-- <div x-data="{modalIsOpen: false}" class="mt-5 w-full px-3  ">
                    ...
                    <div class="mt-5 mx-5 container-md  text-center  flex items-center justify-center flex-wrap">
