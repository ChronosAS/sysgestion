                        ...
                        <x-table.table class="w-full ">
                            <x-slot name="thead">
                                <tr class="bg-blue-900 text-white">
                                    ...
                                    <x-table.th class="pb-3 text-center">
                                        <button type="button" class="inline-block rounded-md bg-blue-600 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 motion-reduce:transition-none" wire:click="addImage">Agregar</button>
                                    </x-table.th>
                                </tr>
                            </x-slot>
                            <x-slot name="tbody">
