                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">
                                @can('beneficiary:create')
                                    <button @click="$dispatch('addBeneficiaryModal')" type="button" class="inline-block cursor-pointer rounded-md bg-green-600 hover:bg-green-500 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 motion-reduce:transition-none">Agregar</button>
                                @endcan
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($beneficiaries as $beneficiary)
                            <tr class="bg-white border-b hover:bg-slate-200/50">
                                ...
                                <td class="px-6 py-4">
                                    <a @click="$dispatch('editBeneficiaryModal',{ beneficiary: {{ $beneficiary->id }} })" class="">
