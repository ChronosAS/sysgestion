<x-dialog-modal maxWidth='2xl' wire:model.live="showAddBeneficiaryModal">
    ...
    <x-slot name="content">
        <form wire:submit='save' class="mt-5  mx-10 container-md  text-center  flex items-center justify-center flex-wrap">
            ...
            <div class="mt-5 w-full px-3 sm:w-1/2">
                <x-label class="text-white" for="phone_number" value="Teléfono" />
            ...
            <div class="mt-5 w-full px-3 sm:w-1/2" >
                <label class="text-white" for="gender" class="block text-sm font-medium text-gray-700">Género</label>
            ...
            <div class=" mt-5 w-full px-3 sm:w-1/2">
                <x-label class="text-white" for="relationship" value="Relación"/>
            ...
            <div class="mt-5 w-full px-3  sm:w-4/2">
                <x-label class="text-white" for="address" value="Dirección" />
