                        ...
                        <table class="w-full border border-blue-700  text-sm text-left rtl:text-right text-white">
                            <thead class="text-xs text-white uppercase bg-blue-800">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3">
                                        @can('official:create')
                                            <x-button-href href="{{ route('officials.create') }}" class="bg-green-600 hover:bg-green-500">
                                                Crear
                                            </x-button-href>
                                        @endcan
                                    </th>
                                ...
                                @forelse ($officials as $official)
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="px-6 py-4 flex gap-6">
                                            <a href="{{ route('officials.show',$official) }}" wire:navigate class="">
                                            ...
                                            <a href="{{ route('officials.edit',$official) }}" wire:navigate class="">
