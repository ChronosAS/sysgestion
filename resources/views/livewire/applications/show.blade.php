                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-right">
                                        <button type="button" class="text-red-600 hover:text-red-900" wire:click="deleteFile({{ $file->id }})" wire:confirm="Esta segura que desea eliminar este documento?">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 relative z-10 w-1/3">
                ...
                <form wire:submit="save">
                    ...
                    <div class="flex justify-end">
                        <button type="button" @click="openFileModal = false" class="bg-gray-600 text-white px-4 py-2 rounded hover:bg-gray-700 mr-2" wire:loading.attr="disabled">Cancelar</button>
                        <button type="submit" wire:click="save" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700" wire:loading.attr="disabled">Subir</button>
                    </div>
                </form>
            </div>
        </div>
