                ...
                <div>
                    <form class="mt-5  mx-10 container-md  text-center  flex items-center justify-center flex-wrap">
                        <div class="mt-5 w-full sm:w-72  px-3">
                            ...
                            <x-input id="name" class="block mt-1 w-full truncate" type="text" name="Cedula de Identidad" :value="old('name')" required autofocus autocomplete="Cedula de Identidad" />
                        </div>
                        <div class="mt-5 w-full px-3 sm:w-1/2">
                            <x-label for="name" value="{{ __('Name') }}" />
                            <x-input id="name" class="block mt-1 w-full truncate" type="text" name="Nombre" :value="old('name')" required autofocus autocomplete="name" />
                        </div>
                        <div class="mt-5 w-full px-3 sm:w-1/2">
                            <x-label for="name" value="{{ __('Apellido') }}" />
                            <x-input id="name" class="block mt-1 w-full truncate" type="text" name="Apellido" :value="old('name')" required autofocus autocomplete="name" />
                        </div>
                        <div class="mt-5 w-full px-3 sm:w-1/2">
                        ...
                        <div class="mt-5  w-full sm:w-72 px-3">
                            ...
                            <x-input id="name" class="block mt-1 w-full truncate" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                        </div>
