                ...
                <form wire:submit='save' class="mt-5  mx-10 container-md  text-center  flex items-center justify-center flex-wrap">
                    ...
                    <div class="mt-5 w-full px-3 sm:w-1/2">
                        <x-label for="password" value="{{ __('Password') }}" />
                            <div class="flex flex-col max-w-sm w-full relative">
                                <div class="abosulte" x-data="{ show: false }">
                                    <input class="mt-1 rounded bg-white block w-full border truncate border-gray-300 py-2 px-3 focus:ring text-base" :type="show ? 'text' : 'password'" name="password" autocomplete="off" type="password" value="LookMaaGreatPassw0rd!">
