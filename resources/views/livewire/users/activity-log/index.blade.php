    ...
    <div class="p-6 lg:p-8 bg-white border-t border-gray-200">
        <div class="relative overflow-x-auto  sm:rounded-lg">
                    ...
                    <tr>
                        <th scope="col" class="px-6 py-3">
                            <div class="flex items-center">
                                Descripción
                                <a href="#" wire:click.prevent="sortBy('event')" ><svg class="w-3 h-3 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="m-4 text-white ">
                {{ $activities->links('vendor.livewire.tailwind-pagination',data: ['scrollTo'=>false]) }}
            </div>
        </div>
    </div>
</div>
