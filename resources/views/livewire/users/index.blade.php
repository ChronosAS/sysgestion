                ...
                <table class="w-full border border-blue-700 shadow-md text-sm text-left rtl:text-right text-white">
                    <thead class="text-xs text-white uppercase bg-blue-800">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">
                                @can('user:create')
                                    <x-button-href href="{{ route('users.create') }}" class="bg-green-600 hover:bg-green-500">
                                        Crear
                                    </x-button-href>
                                @endcan
                            </th>
                            ...
                            @else --}}
                                <tr class="bg-blue-500 border-b border-blue-600 hover:bg-blue-600">
                                    ...
                                    <td class="px-6 py-4 flex gap-6">
                                        <a href="{{ route('user.show',$user) }}" wire:navigate class="font-medium text-black hover:underline">
                                        ...
                                        <a href="{{ route('users.edit',$user) }}" wire:navigate class="ml-1 font-medium text-black hover:underline">
