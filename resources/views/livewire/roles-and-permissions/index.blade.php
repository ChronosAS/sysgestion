<div class="max-w-sm">
    <div class="bg-white overflow-hidden mt-3 p-8 shadow-xl sm:rounded-lg">
        <header class="text-center text-xl font-black breack-all font-sans pb-2">Roles</header>
        <hr class=" text-slate-50 mb-5 w-full"/>
