...
<div class="flex items-center">
    <input
        ...
        @class([
            'focus:ring-lime-500 h-4 w-4 text-lime-600 border-slate-300 rounded cursor-pointer' => !$errors->has($name),
    ...
    <label
        for="{{ $id ?? $title }}"
        @class([
            'ml-3 block text-sm font-medium text-slate-700 hover:underline cursor-pointer' => !$errors->has($name),
